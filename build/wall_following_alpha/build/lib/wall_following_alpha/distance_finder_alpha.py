...
class ScanSub(Node): 
    ...
    def scan_callback(self,data):
        ...
        alpha_right, side_distance_right = angle_calculator(data, int(len(data.ranges)/4), int(len(data.ranges)/4)+50, data.angle_increment*60)
        ...
        alpha_left, side_distance_left = angle_calculator(data, int(len(data.ranges)*(3/4)), int(len(data.ranges)*(3/4)-50), data.angle_increment*60)
